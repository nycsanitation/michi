...
def get_version():
    main_file = os.path.join(CURDIR, "michi", "main.py")
...
setup(
    name="michi",
    version=get_version(),
    author="DSNY, Jeremy Neiman",
    author_email="JeremyNeiman@gmail.com",
    description="",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/nycsanitation/michi",
    packages=find_packages(exclude=EXCLUDE_FROM_PACKAGES),
    include_package_data=True,
    keywords=[],
    scripts=[],
    entry_points={"console_scripts": ["michi=michi.main:main"]},
    zip_safe=False,
